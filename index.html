...
<head>
    ...
    <title>Octobre 2021</title>
    <style>
    @import url('https://fonts.googleapis.com/css2?family=PT+Sans:wght@700&display=swap');
    @import url('https://fonts.googleapis.com/css2?family=Oswald:wght@700&display=swap');
    @import url('https://db.onlinewebfonts.com/c/29800a9e7d146302b8ed9ad2f848db63?family=Druk+Wide+Web+Bold');
        @font-face {
        ...
        @font-face {
            ...
            src: url("Parisine-Regular.otf");
        }
        @font-face {
            font-family: "Druk Wide";
            src: url("Druk_Wide_Bold.ttf");
        }
        @font-face {
        ...
        body{
            font-family: "PT Sans", "Franklin Gothic Medium", monospace;            
        }
        .table{
            height: 100px;
        ...
        .numero{
            ...
            color: white;
            position: relative;
            font-family: "SF Arborcrest", "Franklin Gothic Medium", monospace;
        }
        table {            
            line-height: 120%;
        }
...
<body>
    <table>
        ...
        <tr class="table">
            ...
            <td class="street">Rue Bronski Beat</td>
        ...
        <tr class="table">
            ...
            <td class="numero" style="background-color:rgb(0, 22, 153)">49</td>
        ...
        <tr class="table">
            <td class="numero" style="background-color:#B50645;">74</td>
    ...
    <table class="subwayTable">
        ...
        <tr class="table">
            ...
            <td class="subway">
                ...
                <span>Andreï Sakharov <span class="switch">5</span></span>
                <span>Languedoc</span>
